...
export default class Login extends Component {
    ...
    handleLogin = async () => {
        ...
        try {
            // 1. Encriptar la contraseña proporcionada
            ...
            // 3. Verificar contraseña (comparar hashes)
            const storedPasswordHash = data.password; // Asumiendo que guardaste el hash en la BD
            ...
            this.props.navigation.navigate('Altas');
